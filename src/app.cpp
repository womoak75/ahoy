...
#ifdef THIRDPARTY
        if(tpApp) {
            tpApp->setPublishFkt(std::bind(&PubMqttType::publish, &mMqtt, std::placeholders::_1, std::placeholders::_2,std::placeholders::_3,std::placeholders::_4));
        }
#endif
    }
    #endif
